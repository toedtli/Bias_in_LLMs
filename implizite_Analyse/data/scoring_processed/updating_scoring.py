...
def main():
    ...
    input_csv = "implizite_Analyse/data/scoring_processed/scoring_processed_run_2_2.csv"
    output_csv = "implizite_Analyse/data/scoring_processed/scoring_processed_run_2_2_22.csv"
