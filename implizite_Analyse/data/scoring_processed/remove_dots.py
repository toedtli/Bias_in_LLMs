...
# Read the CSV file
df = pd.read_csv("implizite_Analyse/data/scoring_processed/scoring_processed_run_3.csv")

# Process each row: update only rows that end with a period in "Model Response"
df = df.apply(process_response, axis=1)

# Save the updated dataframe to a new CSV file.
output_path = "implizite_Analyse/data/scoring_processed/scoring_processed_run_3__test.csv"
