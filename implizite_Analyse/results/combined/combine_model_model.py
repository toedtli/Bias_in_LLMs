...
df1 = pd.read_csv("implizite_Analyse/results/run_1/scoring_model_model.csv")
df2 = pd.read_csv("implizite_Analyse/results/run_2/scoring_model_model.csv")
df3 = pd.read_csv("implizite_Analyse/results/run_3/scoring_model_model.csv")
