...
def plot_radar_charts_single_figure(axis_scores, axis_names, models, groups, output_folder="Charts"):
    ...
    output_path = os.path.join(output_folder, "all_models_radar_charts.png")
...
def main():
    csv_path = "explizite_Analyse/statistics/group_axis_statistics_overall.csv"  # Adjust path if needed
